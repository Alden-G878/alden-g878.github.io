...
% master uses ~0.5in margins and ~13.2pt leading; matching both here puts the
% same content in 3 pages at the same density, so this PDF and the master CV
% read the same.
%
...
% same base size, i.e. the two now agree. (This file was 0.86 = 10.3pt, which
...
\entrysep
\textbf{Electronics Head, Robotics Club} \hfill \cvwhen{Aug 2025 - Present}
\begin{itemize}\tightlist
