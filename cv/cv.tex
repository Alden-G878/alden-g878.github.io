...
% ---- Education ------------------------------------------------------------
\section*{Education}
\textbf{\ph{INSTITUTION}} \hfill \ph{EXPECTED GRADUATION}\\
...
% ---- Experience ---------------------------------------------------------
\section*{Experience}
\textbf{\ph{ROLE}} \hfill \ph{START -- END OR ONGOING}\\
...
% ---- Research -----------------------------------------------------------
\section*{Research}
\textbf{\ph{PROJECT / PAPER TITLE}} \hfill \ph{START -- END OR ONGOING}\\
...
% ---- Projects -----------------------------------------------------------
\section*{Projects}
\textbf{\ph{PROJECT NAME}} \hfill \ph{DATES}\\
\ph{TECH STACK}
\begin{itemize}\tightlist
